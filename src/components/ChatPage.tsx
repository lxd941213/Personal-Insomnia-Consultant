...
export function ChatPage({ profile, chatScope = 'general', assessmentResult, initialInput, initialScenario, onBack, onReset }: ChatPageProps) {
  ...
  }, [input, pending, messages, profile, assessmentResult, initialScenario, chatScope]);
